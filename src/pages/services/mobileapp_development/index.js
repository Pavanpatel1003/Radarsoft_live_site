...
import mobileappbanner from "../../../../public/assets/media/service-details/mobileappbanner.png";
              ...
              <div className="row">
                <div className="grid-container">
                  <div className="grid-item">
                    <img src={android.src} alt="android" />
                  </div>
                  <div className="grid-item">
                  ...
                  <div className="grid-item">
                    <img src={swift.src} alt="swift" />
                  </div>
                  <div className="grid-item">
                    <img src={xml.src} alt="xml" />
                  </div>
                  <div className="grid-item">
                    <img src={kotlin.src} alt="kotlin.js" />
                  </div>
                  <div className="grid-item">
